    ...
    <header className="h-16 bg-white/90 dark:bg-dark-900/80 backdrop-blur-xl border-b border-light-border dark:border-dark-border sticky top-0 z-40 transition-colors duration-200">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {breadcrumb.length > 0 && (
            <>
              <span className="text-gray-400 dark:text-gray-500 text-sm">Main</span>
              <span className="text-gray-300 dark:text-gray-600">/</span>
            </>
          )}
          <h1 className="text-gray-900 dark:text-white font-semibold text-lg transition-colors">{title}</h1>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown size={14} className={`text-gray-400 transition-transform ${showThemeMenu ? 'rotate-180' : ''}`} />
            </button>
            ...
            {showThemeMenu && (
              <>
                ...
                {/* Menu */}
                <div className="absolute right-0 top-full mt-2 z-50 w-40 py-1 rounded-xl shadow-lg border
                  ...
                  {themeOptions.map((option) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isActive && (
                          <span className="ml-auto dark:text-lime text-lime-dark">✓</span>
                        )}
                      </button>
                    );
                  })}
