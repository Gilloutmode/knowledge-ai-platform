...
import { Bell, PlayCircle, FileText, Sparkles, Check, MoreVertical, Loader2, BellOff, RefreshCw } from 'lucide-react';
...
const NotificationCard: React.FC<{
  ...
  const iconConfig = {
    new_video: { icon: <PlayCircle size={20} />, color: 'bg-cyan-muted dark:text-cyan text-cyan-dark' },
    analysis_ready: { icon: <FileText size={20} />, color: 'bg-lime-muted dark:text-lime text-lime-dark' },
    content_ready: { icon: <Sparkles size={20} />, color: 'bg-purple-500/15 text-purple-400' },
  };
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <div>
            <h4 className={`font-medium ${notification.read ? 'text-gray-500 dark:text-gray-400' : 'text-gray-900 dark:text-white'}`}>
              {notification.title}
            </h4>
            <p
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {loading && notifications.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12">
          <Loader2 size={32} className="animate-spin dark:text-lime text-lime-dark mb-4" />
              ...
              {notifications.length > 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    Vous recevrez des notifications lorsque de nouvelles vidéos seront détectées
                    ou que des analyses seront terminées.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
