...
import { Youtube, Rss, FileText, ArrowLeft, ArrowRight, Check } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold dark:text-white text-gray-900">Ajouter une source</h1>
          ...
          >
            <div className="flex items-center gap-4">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                selectedType === type.id ? 'bg-lime/20' : 'dark:bg-dark-700 bg-light-200'
              }`}>
                {type.icon}
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold dark:text-white text-gray-900">{type.name}</h3>
                  {!type.available && (
